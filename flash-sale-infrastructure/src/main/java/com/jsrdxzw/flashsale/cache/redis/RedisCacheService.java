package com.jsrdxzw.flashsale.cache.redis;

import com.jsrdxzw.flashsale.cache.DistributedCacheService;
import com.jsrdxzw.flashsale.cache.redis.util.ProtoStuffSerializerUtil;
...
public class RedisCacheService implements DistributedCacheService {
    ...
    public <T> T getObject(String key, Class<T> targetClass) {
        ...
        try {
            return JSONUtil.parseObject(JSONUtil.toJSONString(result), targetClass);
        } catch (Exception e) {
            return null;
        }
    }
